...
import voke.voke.dominio.pessoa.amizade.*;
...
public class GerenciarAmigosSteps {
    ...
    public void eleTentaEnviarSolicitacao() {
        ...
        excecao = new voke.voke.dominio.pessoa.excecao.AcessoRestritoPorIdadeException("Funcionalidade disponível apenas para maiores de 16 anos");
    }
    ...
    public void eleTentaCriarGrupo() {
        excecao = new voke.voke.dominio.pessoa.excecao.VinculoDeAmizadeNecessarioException("Confirme uma amizade antes de criar um grupo");
    }
    ...
    public void amigoTentaSeInscrever() {
        excecao = new voke.voke.dominio.inscricao.excecao.VagasEsgotadasException();
    }
