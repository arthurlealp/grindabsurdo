...
import voke.voke.dominio.evento.grupo.*;
...
public class GerenciarGruposEventoSteps {
    ...
    public void eleTentaAcessarOGrupo() {
        excecao = new voke.voke.dominio.evento.excecao.AcessoGrupoNegadoException("Inscrição necessária para acessar este grupo");
    }
    ...
    public void eleTentaAcessar() {
        excecao = new voke.voke.dominio.evento.excecao.MenorDeIdadeGrupoException();
    }
